...
`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;IACI,8BAA8B;IAC9B,SAAS;IACT,UAAU;IACV,yBAAyB;IACzB,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA,oBAAoB;AACpB;IACI,aAAa;IACb,gBAAgB;IAChB,yBAAyB;IACzB,sBAAsB;IACtB,kBAAkB;IAClB,wCAAwC;IACxC,gBAAgB;IAChB,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,mBAAmB;AACvB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,SAAS;IACT,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,eAAe;IACf,WAAW;AACf;;AAEA,wBAAwB;AACxB;IACI,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,mBAAmB;AACvB;;AAEA,2BAA2B;AAC3B;IACI,eAAe;IACf,iBAAiB;IACjB,mBAAmB;IACnB,cAAc;AAClB;;AAEA,gBAAgB;AAChB;IACI,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,kBAAkB;AACtB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,iBAAiB;IACjB,eAAe;IACf,cAAc;IACd,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,SAAS;AACb;;AAEA;IACI,eAAe;IACf,WAAW;IACX,gBAAgB;IAChB,eAAe;AACnB","sourcesContent":["body {\n    font-family: Arial, sans-serif;\n    margin: 0;\n    padding: 0;\n    background-color: #f8f9fa;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    min-height: 100vh;\n}\n\n/* Заголовок поста */\n.post-wrapper {\n    padding: 16px;\n    max-width: 600px;\n    background-color: #ffffff;\n    border: 1px solid #ddd;\n    border-radius: 8px;\n    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n    overflow: hidden;\n    margin: 25px 0;\n}\n\n.post-header {\n    display: flex;\n    align-items: center;\n    margin-bottom: 16px;\n}\n\n.avatar {\n    width: 48px;\n    height: 48px;\n    border-radius: 50%;\n    margin-right: 12px;\n}\n\n.name-and_date {\n    display: flex;\n    flex-direction: column;\n}\n\n.name {\n    margin: 0;\n    font-size: 16px;\n    font-weight: bold;\n}\n\n.date {\n    font-size: 12px;\n    color: #888;\n}\n\n/* Контентная картинка */\n.content-img {\n    width: 100%;\n    height: auto;\n    border-radius: 8px;\n    margin-bottom: 16px;\n}\n\n/* Заголовок комментариев */\n.title-comments {\n    font-size: 14px;\n    font-weight: bold;\n    margin-bottom: 12px;\n    display: block;\n}\n\n/* Комментарии */\n.container-comments {\n    padding: 0 16px 16px;\n}\n\n.comment-wraper {\n    display: flex;\n    align-items: flex-start;\n    margin-bottom: 25px;\n    justify-content: space-between;\n}\n\n.avatar-comment {\n    width: 32px;\n    height: 32px;\n    border-radius: 50%;\n    margin-right: 20px;\n}\n\n.name-and_message {\n    width: 75%;\n}\n\n.name-comment {\n    font-weight: bold;\n    font-size: 14px;\n    display: block;\n    margin-bottom: 4px;\n}\n\n.text-contetn {\n    font-size: 14px;\n    margin: 0;\n}\n\n.date-comment {\n    font-size: 12px;\n    color: #888;\n    margin-left: 8px;\n    text-align: end;\n}\n"],"sourceRoot":""}]);
// Exports
...
var Post = /*#__PURE__*/function () {
  ...
  return _createClass(Post, [{
    ...
    value: function createPost(data) {
      ...
      newPost.innerHTML = "\n      <div class=\"post-header\">\n          <img class=\"avatar\" src=".concat(data.avatar, " alt=\"\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435 \u043F\u043E\u0441\u0442\u0430\">\n          <div class=\"name-and_date\">\n              <h3 class=\"name\">").concat(data.author.replace(/"/g, ""), "</h3>\n              <div class=\"date\">").concat(format(data.created, "HH:mm dd.MM.yyyy"), "</div>\n          </div>\n      </div>\n       <img class=\"content-img\" src=").concat(data.image, " alt=\"\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435 \u043F\u043E\u0441\u0442\u0430\">\n      <span class=\"title-comments\">Latest comments</span>\n      <div data-post=").concat(data.id, " class=\"container-comments\"></div>\n    ");
      this.container.insertAdjacentElement("afterbegin", newPost);
    }
  }, {
    key: "createComment",
    value: function createComment(element, data) {
      var newComment = document.createElement("div");
      newComment.dataset.comment_id = data.id;
      newComment.className = "comment-wraper";
      newComment.innerHTML = "\n      <img src=".concat(data.avatar, " alt=\"\" class=\"avatar-comment\">\n      <div class=\"name-and_message\">\n          <span class=\"name-comment\">").concat(data.author.replace(/"/g, ""), "</span>\n          <p class=\"text-contetn\">").concat(data.content, "</p>\n      </div>\n      <span class=\"date-comment\">").concat(format(data.created, "HH:mm dd.MM.yyyy"), "</span>\n    ");
...
loadPosts$.pipe(mergeMap(function () {
  ...
  var commentObservables = posts.map(function (post) {
    return ajax.getJSON("http://localhost:9000/posts/".concat(post.id, "/comments/latest")).pipe(map(function (commentsResponse) {
      if (commentsResponse && commentsResponse.status === "ok") {
        ...
        console.error("\u041D\u0435\u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0439 \u043E\u0442\u0432\u0435\u0442 \u043E\u0442 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u0434\u043B\u044F \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0435\u0432 \u043F\u043E\u0441\u0442\u0430 ".concat(post.id, ":"), commentsResponse);
        return {
          postId: post.id,
          comments: []
        };
      ...
      console.error("\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0435\u0432 \u0434\u043B\u044F \u043F\u043E\u0441\u0442\u0430 ".concat(post.id), error);
      return of({
        postId: post.id,
        comments: []
      });
      ...
      postsWithComments.forEach(function (postWithComments) {
        ...
        if (postElement) {
          if (postWithComments.comments) {
            postWithComments.comments.forEach(function (commentData) {
  ...
  error: function error(err) {
    return console.error("Общая ошибка", err);
  }
});
;// ./src/index.js
